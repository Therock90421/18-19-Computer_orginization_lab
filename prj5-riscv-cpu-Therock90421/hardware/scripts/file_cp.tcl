...
if {$act == "pst_sim"} {
	exec cp ./${project_name}/${project_name}.sim/sim_1/synth/timing/riscv_cpu_test_time_synth.wdb \
	...
	exec cp ./${project_name}/${project_name}.sim/sim_1/behav/riscv_cpu_test_behav.wdb \
