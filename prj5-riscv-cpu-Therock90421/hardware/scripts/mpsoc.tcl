...
#=============================================
  ...
  set riscv_axi_ic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 riscv_axi_ic ]
  set_property -dict [list CONFIG.NUM_MI {2} CONFIG.NUM_SI {1}] $riscv_axi_ic
...
#==============================================
  ...
  set riscv_cpu_axi_mmio [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 riscv_cpu_axi_mmio]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4Lite} ] $riscv_cpu_axi_mmio

  set riscv_cpu_axi_mem [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 riscv_cpu_axi_mem]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4Lite} ] $riscv_cpu_axi_mem

  set_property CONFIG.ASSOCIATED_BUSIF {riscv_cpu_axi_mmio:riscv_cpu_axi_mem} [get_bd_ports ps_fclk_clk0]
...
#=============================================
  connect_bd_net -net armv8_ps_fclk_0 [get_bd_pin zynq_mpsoc/pl_clk0] \
			...
			[get_bd_pins riscv_axi_ic/S00_ACLK] \
			[get_bd_pins riscv_axi_ic/M00_ACLK] \
			[get_bd_pins riscv_axi_ic/M01_ACLK] \
			[get_bd_pins riscv_axi_ic/ACLK] \
...
#=============================================
  ...
  connect_bd_net -net riscv_cpu_reset_n [get_bd_pins riscv_cpu_reset_n] \
			[get_bd_pins riscv_axi_ic/ARESETN] \
			[get_bd_pins arm_axi_ic/ARESETN] \
			[get_bd_pins riscv_axi_ic/S00_ARESETN] \
			[get_bd_pins riscv_axi_ic/M00_ARESETN] \
  ...
  connect_bd_net -net rst_zynq_mpsoc_99M_peripheral_aresetn [get_bd_pins arm_axi_ic/S00_ARESETN] \
			...
			[get_bd_pins riscv_axi_ic/M01_ARESETN]
...
#==============================================
  ...
  connect_bd_intf_net -intf_net riscv_cpu_master [get_bd_intf_pins riscv_axi_ic/S00_AXI] \
			[get_bd_intf_pins riscv_cpu_axi_mem] 

  connect_bd_intf_net -intf_net riscv_cpu_slave [get_bd_intf_pins arm_axi_ic/M00_AXI] \
			[get_bd_intf_pins riscv_cpu_axi_mmio] 

  connect_bd_intf_net -intf_net axi_ddr_if [get_bd_intf_pins riscv_axi_ic/M00_AXI] \
			[get_bd_intf_pins zynq_mpsoc/S_AXI_HP0_FPD]

  connect_bd_intf_net -intf_net axi_uart [get_bd_intf_pins riscv_axi_ic/M01_AXI] \
...
#=============================================
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x80020000 [get_bd_addr_spaces zynq_mpsoc/Data] [get_bd_addr_segs riscv_cpu_axi_mmio/Reg] PS_VIEW_RISCV_REG
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces riscv_cpu_axi_mem] [get_bd_addr_segs zynq_mpsoc/SAXIGP2/HP0_DDR_LOW] RISCV_MEM
  create_bd_addr_seg -range 0x1000 -offset 0x80010000 [get_bd_addr_spaces riscv_cpu_axi_mem] [get_bd_addr_segs axi_uart/S_AXI/Reg] RISCV_UART
