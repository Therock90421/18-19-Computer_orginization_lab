...
if {$act == "rtl_chk" || $act == "sch_gen" || $act == "bhv_sim" || $act == "pst_sim" || $act == "bit_gen"} {
	...
	if {$act == "rtl_chk" || $act == "sch_gen" || $act == "bhv_sim" || $act == "pst_sim"} {
		...
		import_files -force -norecurse -fileset sources_1 ./${project_name}/${project_name}.srcs/sources_1/bd/mpsoc/hdl/${bd_design}_wrapper.v
		...
		# setting top module of sources_1
		set_property "top" mips_cpu_fpga [get_filesets sources_1]
		update_compile_order -fileset [get_filesets sources_1]
	}
	...
	if {$act == "rtl_chk" || $act == "sch_gen"} {
		...
		if {$act == "pst_sim"} {
			...
			# synthesizing design
			synth_design -top mips_cpu_fpga -part ${device}
		}
		...
		write_checkpoint -force ${dcp_dir}/${rpt_prefix}synth.dcp
		...
		write_checkpoint -force ${dcp_dir}/${rpt_prefix}route.dcp
